<div class='loader-container loadingScreen'>
...
.smoke span:nth-child(1) {
  ...
  animation: smokeAnim-0 ease-out 0.65s infinite;
}
...
.smoke span:nth-child(2) {
  ...
  left: -50px;
  box-shadow: 0px 0px 5px #fff;
  animation: smokeAnim-1 ease-out 0.25s infinite;
}
...
.smoke span:nth-child(4) {
  ...
  left: -50px;
  box-shadow: 0px 0px 5px #fff;
  animation: smokeAnim-3 ease-out 0.25s infinite;
}
...
.smoke span:nth-child(7) {
  ...
  left: -50px;
  box-shadow: 0px 0px 5px #fff;
  animation: smokeAnim-6 ease-out 0.4s infinite;
}
...
.smoke span:nth-child(8) {
  ...
  left: -50px;
  box-shadow: 0px 0px 5px #fff;
  animation: smokeAnim-7 ease-out 0.2s infinite;
}
...
.smoke span:nth-child(9) {
  ...
  left: -50px;
  box-shadow: 0px 0px 5px #fff;
  animation: smokeAnim-8 ease-out 0.5s infinite;
}
...
.smoke span:nth-child(10) {
  ...
  left: -50px;
  box-shadow: 0px 0px 5px #fff;
  animation: smokeAnim-9 ease-out 0.65s infinite;
}
...
.meteors-container span:nth-child(1) {
  ...
  left: 100%;
  box-shadow: 0px 0px 5px #fff;
  animation: meterosAnim-0 linear 0.55s infinite;
}
...
.meteors-container span:nth-child(4) {
  ...
  left: 100%;
  box-shadow: 0px 0px 5px #fff;
  animation: meterosAnim-3 linear 0.3s infinite;
}
...
.meteors-container span:nth-child(5) {
  ...
  left: 100%;
  box-shadow: 0px 0px 5px #fff;
  animation: meterosAnim-4 linear 0.55s infinite;
}
...
.meteors-container span:nth-child(6) {
  ...
  left: 100%;
  box-shadow: 0px 0px 5px #fff;
  animation: meterosAnim-5 linear 0.35s infinite;
}
